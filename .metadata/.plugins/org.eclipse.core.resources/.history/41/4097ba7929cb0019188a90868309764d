...
public class productcontroller {
	...
	public productcontroller() {
		...
		public void update(String id, String product_name, String product_description,String category_id ,InputStream inputStream) {
		try {
			String querry ="UPDATE `product` SET `product_name` = '"+product_name+"', `product_description` = '"+product_description+"',`image` =? , `category_id` = '"+category_id+"'WHERE `product`.`product_id` = "+id;  
